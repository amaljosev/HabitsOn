                              ...
                              child: ListView(
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      HabitCompletionDetailWidget(
                                          size: size,
                                          goalName: 'CURRENT',
                                          completedData: analyseCtrl.streakCount
                                              .toString(),
                                          target: analyseCtrl.higestStreak
                                              .toString(),
                                  ...
                                  analyseCtrl.isTodayTaskComplete.value ||
                                          analyseCtrl.isNoHabitDay.value
                                      ? Column(
                                          children: [
                                            Row(
                                              children: [
                                                  ...
                                                  child: Padding(
                                                    padding:
                                                        EdgeInsets.symmetric(
                                                            ...
                                                            vertical: 13.h),
                                                    child: Text(
                                                      analyseCtrl.isNoHabitDay
                                                              .value
                                                          ? "You have not selected this day for your habit."
                                            ...
                                            SizedBox(
                                              ...
                                              width: 100.w,
                                              child: Center(
                                                child: Lottie.asset(analyseCtrl
                                                        .isNoHabitDay.value
                                                    ? 'assets/lottie/Animation - 1715836333725.json'
